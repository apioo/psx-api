...
<div class="psx-resource psx-api-generator-html-schema" data-status="1" data-path="/foo/bar">
    ...
    <div class="psx-resource-method" data-method="GET">
        ...
        <div class="psx-resource-data psx-resource-query">
            ...
            <div class="psx-resource-data-content">
                <div id="psx-type-1a543de6ef793b231e7e4c78844dbc84" class="psx-complex-type">
                    <h1>path</h1>
        ...
        <div class="psx-resource-data psx-resource-query">
            ...
            <div class="psx-resource-data-content">
                <div id="psx-type-21726c1551deab178a68a7ffac656c75" class="psx-complex-type">
                    <h1>query</h1>
                    <table class="table psx-type-properties">
                        <colgroup>
                            <col width="20%" />
        ...
        <div class="psx-resource-data psx-resource-response">
            ...
            <div class="psx-resource-data-content">
                <div id="psx-type-c6491059d9103dc5bb112e51828416d9" class="psx-complex-type">
                    <h1>collection</h1>
                    <table class="table psx-type-properties">
                        <colgroup>
                            <col width="20%" />
    ...
    <div class="psx-resource-method" data-method="POST">
        ...
        <div class="psx-resource-data psx-resource-query">
            ...
            <div class="psx-resource-data-content">
                <div id="psx-type-5d08e74148a1303824e5d6d0dc6ab70b" class="psx-complex-type">
                    <h1>query</h1>
                    <table class="table psx-type-properties">
                        <colgroup>
                            <col width="20%" />

...
use PSX\Api\Generator\Spec\GraphQL;
...
class GraphQLTest extends GeneratorTestCase
{
    public function testGenerate()
    {
        ...
        $expect = file_get_contents(__DIR__ . '/resource/graphql.graphql');
    ...
    public function testGenerateAll()
    {
        ...
        $expect = file_get_contents(__DIR__ . '/resource/graphql_collection.graphql');
        $expect = str_replace(array("\r\n", "\r"), "\n", $expect);
